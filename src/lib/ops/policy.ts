...
export const DEFAULT_POLICY: Policy = {
  may: ["http_probe", "tls_expiry", "dns_lookup", "http_headers", "pm2_list", "pm2_logs", "git_log", "git_show", "read_file", "grep_repo", "disk_free", "pm2_restart", "pm2_start", "run_tests", "call_hook"],
...
export const ASK_BEFORE_ACTING: Policy = {
  may: ["http_probe", "tls_expiry", "dns_lookup", "http_headers", "pm2_list", "pm2_logs", "git_log", "git_show", "read_file", "grep_repo", "disk_free"],
  ask: ["pm2_restart", "pm2_start", "run_tests", "call_hook", "redeploy_previous"],
  never: ["db_migrate", "delete_data", "rotate_secret", "destroy_infra"],
...
export const OBSERVE_ONLY: Policy = {
  may: ["http_probe", "tls_expiry", "dns_lookup", "http_headers", "pm2_list", "pm2_logs", "git_log", "git_show", "read_file", "grep_repo", "disk_free"],
  ask: [],
  never: ["pm2_restart", "pm2_start", "run_tests", "call_hook", "redeploy_previous", "db_migrate", "delete_data", "rotate_secret", "destroy_infra"],
